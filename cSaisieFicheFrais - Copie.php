...
// à revoir
$reponse = $bdd->query('SELECT * FROM lignefraisforfait WHERE idFraisForfait = "ETP"');
$donnees = $reponse->fetch();

$reponse2 = $bdd->query('SELECT * FROM lignefraisforfait WHERE idFraisForfait = "KM"');
$donnees2 = $reponse2->fetch();

$reponse3 = $bdd->query('SELECT * FROM lignefraisforfait WHERE idFraisForfait = "NUI"');
$donnees3 = $reponse3->fetch();

$reponse4 = $bdd->query('SELECT * FROM lignefraisforfait WHERE idFraisForfait = "REP"');
                                ...
                                
{
			...
			<?php
				...
				if(isset($_POST['envoie2']))
					...
					$sth = $bdd->prepare('INSERT INTO lignefraishorsforfait (`id`, `idVisiteur`, `mois`, `libelle`, `date`, `montant`) 
						VALUES (NULL, :idVisiteur, :mois  ,:libelle, :date , :montant )');
